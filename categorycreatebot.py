...
today = date.today()
todaysmonth = today.strftime("%Y-%m")
tomorrow = date.today() + timedelta(days=50)
tomorrowsmonth = tomorrow.strftime("%Y-%m")
...
def main(*args: str) -> None:
	...
	for cat in categories:
		catname = "Kategori:" + cat[0].format(tomorrowsmonth)
		catcontent = cat[1]
